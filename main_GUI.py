...
class aFrame(Frame):
    ...
    def initUI(self):
        self.parent.title("Image Forgery Detection")
    ...
    def onDetect(self):
        if self.imageName == "":
            ...
            imageResultPath = copymovedetection.detect(self.imagePath, self.imageName, 'C:/Users/admin/PycharmProjects/student/testcaser/', blockSize=32)
